...
- `엑셀 문서 ★2026_8월 업무추진비 집행내역(의장단_의정운영공통경비).xlsx` — 21,485 bytes — 38 rows
  - 의장: OK / parsed 21 / mapping {'date': 1, 'merchant': 2, 'purpose': 3, 'people': 5, 'amount': 6, 'method': 7}
  - 부의장: OK / parsed 8 / mapping {'date': 1, 'merchant': 2, 'purpose': 3, 'people': 5, 'amount': 6, 'method': 7}
  - 의정운영공통경비: OK / parsed 9 / mapping {'date': 1, 'merchant': 2, 'purpose': 3, 'people': 4, 'amount': 5, 'method': 6}
- `엑셀 문서 ★2026_8월 업무추진비 집행내역(기관운영_시책추진).xlsx` — 16,385 bytes — 10 rows
  - 기관운영업무추진비(의회사무과장): OK / parsed 9 / mapping {'date': 1, 'merchant': 2, 'purpose': 3, 'people': 5, 'amount': 6, 'method': 7}
  - 시책운영업무추진비: OK / parsed 1 / mapping {'date': 1, 'merchant': 2, 'purpose': 3, 'people': 4, 'amount': 5, 'method': 6}
- `pdf 문서 2026년 업무추진비사용내역(2월)_기관운영업무추진비.pdf` — 50,214 bytes — 2 rows
  - pdf-page-1: OK / parsed 2 / mapping {'date': 0, 'amount': 1, 'merchant': 2, 'purpose': 3, 'people': 4, 'role': 7}
- `pdf 문서 2026년 업무추진비사용내역(2월)_의정운영공통경비.pdf` — 79,690 bytes — 27 rows
  - pdf-page-1: OK / parsed 27 / mapping {'date': 0, 'amount': 1, 'merchant': 2, 'purpose': 3, 'people': 4, 'role': 7}
- `pdf 문서 2026년 업무추진비사용내역(2월)_부의장.pdf` — 56,491 bytes — 6 rows
  - pdf-page-1: OK / parsed 6 / mapping {'date': 0, 'amount': 1, 'merchant': 2, 'purpose': 3, 'people': 4, 'role': 7}
- `pdf 문서 2026년 업무추진비사용내역(2월)_의장.pdf` — 71,070 bytes — 24 rows
...
- `pdf 문서 업무추진비 사용내역 공개(9월_부의장).pdf` — 46,579 bytes — 5 rows
  - pdf-page-1: OK / parsed 5 / mapping {'date': 0, 'amount': 1, 'merchant': 2, 'purpose': 3, 'people': 4, 'role': 7}
- `pdf 문서 업무추진비 사용내역 공개(9월_의장).pdf` — 67,242 bytes — 22 rows
  - pdf-page-1: OK / parsed 22 / mapping {'date': 0, 'amount': 1, 'merchant': 2, 'purpose': 3, 'people': 4, 'role': 7}
- `pdf 문서 업무추진비 사용내역 공개(8월_기관운영업무추진비).pdf` — 50,539 bytes — 1 rows
  - pdf-page-1: OK / parsed 1 / mapping {'date': 0, 'amount': 1, 'merchant': 2, 'purpose': 3, 'people': 4, 'role': 7}
- `pdf 문서 업무추진비 사용내역 공개(8월_의정운영공통경비).pdf` — 79,411 bytes — 28 rows
  - pdf-page-1: OK / parsed 28 / mapping {'date': 0, 'amount': 1, 'merchant': 2, 'purpose': 3, 'people': 4, 'role': 7}
- `pdf 문서 업무추진비 사용내역 공개(8월_부의장).pdf` — 62,729 bytes — 11 rows
  - pdf-page-1: OK / parsed 11 / mapping {'date': 0, 'amount': 1, 'merchant': 2, 'purpose': 3, 'people': 4, 'role': 7}
- `pdf 문서 업무추진비 사용내역 공개(8월_의장).pdf` — 59,422 bytes — 12 rows
